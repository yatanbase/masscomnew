...
<li><NavLink to="/Staff" className="dropdown-item"> Staff</NavLink> </li><li> <hr className="dropdown-divider" /> </li>
  ...
  <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
    ...
    <li className="dropend">
      <a className="dropdown-item dropdown-toggle" href="#" id="annualReportsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
        Annual Reports
      </a>
    ...
    <li className="dropend">
      <a className="dropdown-item dropdown-toggle" href="#" id="eResourcesDropdown" data-bs-toggle="dropdown" aria-expanded="false">
        eResources
      </a>
