...
const Page31 = () => {
  return (
    <>    <div style={{width:'100vw',height:'100%',display:'flex',alignItems:'center',justifyContent:'start',backgroundColor:'darkred'}}>
      <img src={Book} style={{height:'5rem',width:'auto',paddingLeft:'2rem',opacity:'87%'}} alt="" />
      <div className="" style={{width:'55%',display:'flex',justifyContent:'end',paddingRight:'5px',color:'white',backgroundColor:'darkred'}}>
      <h2 style={{fontFamily:'Nova Square,arial',fontWeight:'900',fontSize:'4rem'}}>Bookistan Club</h2>
      </div>
...
<div style={{display:'flex'}}>
    <div style={{width:'75vw', height:'80vh' }}>
        ...
        <img src={Image1} alt="Gallery Image 2" style={{ width: '100%', height: '400px', objectFit: 'fill', boxShadow: '0 0 25px 2px rgba(0, 0, 0, 0.4)', borderRadius: '20px' }} />
        <p style={{ textAlign: 'center', fontFamily: 'Times New Roman, serif',marginBottom:'none',fontSize:'1.5rem',color:'black' }}> National Space Day 2024 <br></br><span style={{position:'relative',bottom:'15px',color:'darkred',fontSize:'1.3rem'}}>know more &gt;</span></p>
        </div></a>
  ...
  <div style={{width:'26vw', height:'80vh' }}>
      ...
      <div style={{width:'100%',height:'6vh', borderBottom:'3px dotted darkred',display:'flex'}}>
        {/* <div style={{height:'50px',width:'20px',backgroundColor:'darkred',position:'relative',right:'13px'}}></div> */}
      <p style={{fontSize:'2.5rem',fontWeight:'bold',position:'relative',bottom:'8px'}}> News at BOOK<span style={{color:'darkred'}}>ISTAN</span></p>
      </div>


      <a href={Bookistan_pdf} target='_blank' className='text-decoration-none' style={{ display: 'block', marginBottom: '20px', position:'relative',left:'10px',color:'black',fontSize:'1.2rem' ,borderBottom:'1px solid lightgray',padding:'.5rem'}}>Literary discussion on Harishankar Parsai
           <img src={Gif} alt="newicon" height="8" width="27" style={{ marginleft: '5px', position:'relative',left:'5px'}} />
        <div style={{backgroundColor:'darkred',color:'white',borderRadius:'5px',width:'50%'}}><p>PR 8 August</p></div>
           </a>
