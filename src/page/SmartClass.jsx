  ...
  return (
    <div className="container mt-4">
      <div className="card p-3 shadow">
        ...
        <p>
          SJMC's Smart Class is a digitally enhanced classroom setup equipped with smart boards,
          projectors, and internet access to ensure interactive and effective teaching.
        </p>
      </div>
    </div>
  );
